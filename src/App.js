          ...
          <div className="content">
            <main>
              <div
                ref={homeRef}
                className={`section ${
                  homeVisible ? "section-visible" : "section-hidden"
                }`}
              >
                <Home
              ...
              <div
                ref={aboutRef}
                className={`section ${
                  aboutVisible ? "section-visible" : "section-hidden"
                }`}
              >
                <About />
              </div>
              <div
                ref={skillsRef}
                className={`section ${
                  skillsVisible ? "section-visible" : "section-hidden"
                }`}
              >
                <Skills />
              </div>
              ...
              <div
                ref={contactsRef}
                className={`section ${
                  contactsVisible ? "section-visible" : "section-hidden"
                }`}
              >
                <Contacts />
              </div>
              <div
                ref={footerRef}
                className={`section ${
                  footerVisible ? "section-visible" : "section-hidden"
                }`}
              >
                <Footer />
              </div>
